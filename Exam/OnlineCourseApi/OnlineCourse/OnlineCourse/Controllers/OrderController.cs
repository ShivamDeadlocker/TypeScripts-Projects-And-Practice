...
{
    /// <summary>
    /// This Class Having A Api related to Order i.e Enrolling the user in the courses and updating the seats
    /// </summary>
    public class OrderController : ApiController
    {
        ...
        //Updating the Seats And Enrolling the Course And Invoice Generation
        [HttpPost]
            ...
            using (conn)
            {
                ...
                catch (Exception ex)
                {
                    list.Add(new
                    {
                        ...
                        Message = "Invoice Generation is Failed!!!!" + ex.Message,
                        IsAvailable = false
                    });
                    return list;
                }
        ...
        //Getting the enrolled course data of the user 
        [HttpGet]
