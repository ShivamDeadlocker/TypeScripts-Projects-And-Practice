...
//Note: No Need To Download the Jquery for this project, This Project is simple html , cs js and browser environment.
...
// =================== Loading User Details / User Nav Bar Options And Cart Count  =================== //
