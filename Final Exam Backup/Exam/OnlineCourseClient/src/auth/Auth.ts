...
export function register(e:JQuery.SubmitEvent): void {

  //When Form Submit then Page is reloading, But preventDefault() stopped the page reloading, after the submit
  ...
  $.ajax({
    ...
    success: function (data: UserDetails[]) {
...
//Function for login
export function login(e:JQuery.SubmitEvent):void {
